...
void generateCirclePointsArray() {
    ...
    Не очень оптимальный вариант, да и результат получается
    не совсем равномерный, видны небольшие углы.
    Сделал больше из интереса, а для реальных задач лучше 
    использовать generateCirclePointsArray2, расположенный ниже.
    */
...
void generateCirclePointsArray2() {
    ...
    но гораздо короче, точнее и наверное оптимальнее.
